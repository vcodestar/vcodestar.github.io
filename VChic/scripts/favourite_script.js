import { favourite_items } from './favourite_items.js'; 
...
export function findItem() {
    ...
    const itemExists = favourite_items.some(item => 
...
function loadCategoryItems(category) {
    ...
    const filteredItems = favourite_items.filter(item => item.category === category.toLowerCase());
